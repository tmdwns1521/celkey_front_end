...
interface IKeywordMonthly {
  ...
  search_total: number;
  publishing_blog: number;
  publishing_cafe: number;
  publishing_total: number;
}

interface Props {
  KEYWORD_MONTHLY: IKeywordMonthly[];
}
